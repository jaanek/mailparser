                ...
                if (node.isAttachment) {
                    ...
                    if (
                        ...
                        try {
                          ...
                          console.error(`Decoding error! charset: ${charset}, iconv.decodeStream: `, E);
                          // convert japanese encodings - https://github.com/narirou/jconv
                          // try {
                          //   result = jconv.convert(str, from, to);
                          // } catch(E) {
                          //   console.error(E);
                          //   result = str;
                          //   node.contentStream = decodeStream;
